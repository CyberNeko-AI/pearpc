...
{
    return (((clr & 0x000000f8) >> 3) | ((clr & 0x0000f800) >> 6) | ((clr & 0x01f80000) >> 9));
}
...
{
    return (((uint32)(clr & 0x001f)) | ((uint32)(clr & 0x03E0) << 3) | ((uint32)(clr & 0x7c00) << 6) |
...
int ppc_opc_vmuleub(PPC_CPU_State &aCPU)
{
    ...
    for (int i = 0; i < 8; i++) {
        res = (uint16)aCPU.vr[vrA].b[VECT_EVEN(i)] * (uint16)aCPU.vr[vrB].b[VECT_EVEN(i)];
...
int ppc_opc_vmulesb(PPC_CPU_State &aCPU)
{
    ...
    for (int i = 0; i < 8; i++) {
        res = (sint16)aCPU.vr[vrA].sb[VECT_EVEN(i)] * (sint16)aCPU.vr[vrB].sb[VECT_EVEN(i)];
...
int ppc_opc_vmuleuh(PPC_CPU_State &aCPU)
{
    ...
    for (int i = 0; i < 4; i++) {
        res = (uint32)aCPU.vr[vrA].h[VECT_EVEN(i)] * (uint32)aCPU.vr[vrB].h[VECT_EVEN(i)];
...
int ppc_opc_vmulesh(PPC_CPU_State &aCPU)
{
    ...
    for (int i = 0; i < 4; i++) {
        res = (sint32)aCPU.vr[vrA].sh[VECT_EVEN(i)] * (sint32)aCPU.vr[vrB].sh[VECT_EVEN(i)];
...
int ppc_opc_vmuloub(PPC_CPU_State &aCPU)
{
    ...
    for (int i = 0; i < 8; i++) {
        res = (uint16)aCPU.vr[vrA].b[VECT_ODD(i)] * (uint16)aCPU.vr[vrB].b[VECT_ODD(i)];
...
int ppc_opc_vmulosb(PPC_CPU_State &aCPU)
{
    ...
    for (int i = 0; i < 8; i++) {
        res = (sint16)aCPU.vr[vrA].sb[VECT_ODD(i)] * (sint16)aCPU.vr[vrB].sb[VECT_ODD(i)];
...
int ppc_opc_vmulouh(PPC_CPU_State &aCPU)
{
    ...
    for (int i = 0; i < 4; i++) {
        res = (uint32)aCPU.vr[vrA].h[VECT_ODD(i)] * (uint32)aCPU.vr[vrB].h[VECT_ODD(i)];
...
int ppc_opc_vmulosh(PPC_CPU_State &aCPU)
{
    ...
    for (int i = 0; i < 4; i++) {
        res = (sint32)aCPU.vr[vrA].sh[VECT_ODD(i)] * (sint32)aCPU.vr[vrB].sh[VECT_ODD(i)];
...
int ppc_opc_vmsumubm(PPC_CPU_State &aCPU)
{
    ...
    for (int i = 0; i < 4; i++) {
        ...
        temp += (uint16)aCPU.vr[vrA].b[i << 2] * (uint16)aCPU.vr[vrB].b[i << 2];

        temp += (uint16)aCPU.vr[vrA].b[(i << 2) + 1] * (uint16)aCPU.vr[vrB].b[(i << 2) + 1];

        temp += (uint16)aCPU.vr[vrA].b[(i << 2) + 2] * (uint16)aCPU.vr[vrB].b[(i << 2) + 2];

        temp += (uint16)aCPU.vr[vrA].b[(i << 2) + 3] * (uint16)aCPU.vr[vrB].b[(i << 2) + 3];
...
int ppc_opc_vmsumuhm(PPC_CPU_State &aCPU)
{
    ...
    for (int i = 0; i < 4; i++) {
        ...
        temp += (uint32)aCPU.vr[vrA].h[i << 1] * (uint32)aCPU.vr[vrB].h[i << 1];
        temp += (uint32)aCPU.vr[vrA].h[(i << 1) + 1] * (uint32)aCPU.vr[vrB].h[(i << 1) + 1];
...
int ppc_opc_vmsummbm(PPC_CPU_State &aCPU)
{
    ...
    for (int i = 0; i < 4; i++) {
        ...
        temp += (sint16)aCPU.vr[vrA].sb[i << 2] * (uint16)aCPU.vr[vrB].b[i << 2];
        temp += (sint16)aCPU.vr[vrA].sb[(i << 2) + 1] * (uint16)aCPU.vr[vrB].b[(i << 2) + 1];
        temp += (sint16)aCPU.vr[vrA].sb[(i << 2) + 2] * (uint16)aCPU.vr[vrB].b[(i << 2) + 2];
        temp += (sint16)aCPU.vr[vrA].sb[(i << 2) + 3] * (uint16)aCPU.vr[vrB].b[(i << 2) + 3];
...
int ppc_opc_vmsumshm(PPC_CPU_State &aCPU)
{
    ...
    for (int i = 0; i < 4; i++) {
        ...
        temp += (sint32)aCPU.vr[vrA].sh[i << 1] * (sint32)aCPU.vr[vrB].sh[i << 1];
        temp += (sint32)aCPU.vr[vrA].sh[(i << 1) + 1] * (sint32)aCPU.vr[vrB].sh[(i << 1) + 1];
...
int ppc_opc_vavgub(PPC_CPU_State &aCPU)
{
    ...
    for (int i = 0; i < 16; i++) {
        res = (uint16)aCPU.vr[vrA].b[i] + (uint16)aCPU.vr[vrB].b[i] + 1;
...
int ppc_opc_vavguh(PPC_CPU_State &aCPU)
{
    ...
    for (int i = 0; i < 8; i++) {
        res = (uint32)aCPU.vr[vrA].h[i] + (uint32)aCPU.vr[vrB].h[i] + 1;
...
int ppc_opc_vavguw(PPC_CPU_State &aCPU)
{
    ...
    for (int i = 0; i < 4; i++) {
        res = (uint64)aCPU.vr[vrA].w[i] + (uint64)aCPU.vr[vrB].w[i] + 1;
...
int ppc_opc_vavgsb(PPC_CPU_State &aCPU)
{
    ...
    for (int i = 0; i < 16; i++) {
        res = (sint16)aCPU.vr[vrA].sb[i] + (sint16)aCPU.vr[vrB].sb[i] + 1;
...
int ppc_opc_vavgsh(PPC_CPU_State &aCPU)
{
    ...
    for (int i = 0; i < 8; i++) {
        res = (sint32)aCPU.vr[vrA].sh[i] + (sint32)aCPU.vr[vrB].sh[i] + 1;
...
int ppc_opc_vavgsw(PPC_CPU_State &aCPU)
{
    ...
    for (int i = 0; i < 4; i++) {
        res = (sint64)aCPU.vr[vrA].sw[i] + (sint64)aCPU.vr[vrB].sw[i] + 1;
...
/*
 *  === Native JIT codegen for AltiVec operations ===
 */
...
void gen_check_vec(JITC &jitc)
{
    ...
    if (!jitc.checkedVector) {
        ...
        // Vector disabled: raise NO_VEC exception
        jitc.asmMOV(W0, jitc.pc);
        jitc.asmCALL_cpu(PPC_STUB_NO_VEC_EXC);
        // ppc_no_vec_exception_asm does not return

        jitc.asmAssertHERE(target, "check_vec");
        jitc.checkedVector = true;
    }
#endif
}

typedef void (*VecBinopEmitter)(JITC &jitc);

static inline JITCFlow gen_vec_binop(JITC &jitc, VecBinopEmitter emit_op, int vrD, int vrA, int vrB)
{
    gen_check_vec(jitc);
    jitc.clobberAll();
    jitc.asmLDR_Q_cpu(V0, VR_OFS(vrA));
    jitc.asmLDR_Q_cpu(V1, VR_OFS(vrB));
    emit_op(jitc);
    jitc.asmSTR_Q_cpu(V0, VR_OFS(vrD));
    return flowContinue;
}

static void emit_vxor(JITC &jitc)
{
    jitc.asmEOR_V(V0, V0, V1);
}
JITCFlow ppc_opc_gen_vxor(JITC &jitc)
{
    int vrD, vrA, vrB;
    PPC_OPC_TEMPL_X(jitc.current_opc, vrD, vrA, vrB);
    return gen_vec_binop(jitc, emit_vxor, vrD, vrA, vrB);
}

static void emit_vor(JITC &jitc)
{
    jitc.asmORR_V(V0, V0, V1);
}
JITCFlow ppc_opc_gen_vor(JITC &jitc)
{
    int vrD, vrA, vrB;
    PPC_OPC_TEMPL_X(jitc.current_opc, vrD, vrA, vrB);
    return gen_vec_binop(jitc, emit_vor, vrD, vrA, vrB);
}

static void emit_vand(JITC &jitc)
{
    jitc.asmAND_V(V0, V0, V1);
}
JITCFlow ppc_opc_gen_vand(JITC &jitc)
{
    int vrD, vrA, vrB;
    PPC_OPC_TEMPL_X(jitc.current_opc, vrD, vrA, vrB);
    return gen_vec_binop(jitc, emit_vand, vrD, vrA, vrB);
}

static void emit_vandc(JITC &jitc)
{
    jitc.asmBIC_V(V0, V0, V1);
}
JITCFlow ppc_opc_gen_vandc(JITC &jitc)
{
    int vrD, vrA, vrB;
    PPC_OPC_TEMPL_X(jitc.current_opc, vrD, vrA, vrB);
    return gen_vec_binop(jitc, emit_vandc, vrD, vrA, vrB);
}

static void emit_vnor(JITC &jitc)
{
    jitc.asmORR_V(V0, V0, V1);
    jitc.asmMVN_V(V0, V0);
}
JITCFlow ppc_opc_gen_vnor(JITC &jitc)
{
    int vrD, vrA, vrB;
    PPC_OPC_TEMPL_X(jitc.current_opc, vrD, vrA, vrB);
    return gen_vec_binop(jitc, emit_vnor, vrD, vrA, vrB);
}

static void emit_vaddubm(JITC &jitc)
{
    jitc.asmADD_V_16B(V0, V0, V1);
}
JITCFlow ppc_opc_gen_vaddubm(JITC &jitc)
{
    int vrD, vrA, vrB;
    PPC_OPC_TEMPL_X(jitc.current_opc, vrD, vrA, vrB);
    return gen_vec_binop(jitc, emit_vaddubm, vrD, vrA, vrB);
}

static void emit_vadduhm(JITC &jitc)
{
    jitc.asmADD_V_8H(V0, V0, V1);
}
JITCFlow ppc_opc_gen_vadduhm(JITC &jitc)
{
    int vrD, vrA, vrB;
    PPC_OPC_TEMPL_X(jitc.current_opc, vrD, vrA, vrB);
    return gen_vec_binop(jitc, emit_vadduhm, vrD, vrA, vrB);
}

static void emit_vadduwm(JITC &jitc)
{
    jitc.asmADD_V_4S(V0, V0, V1);
}
JITCFlow ppc_opc_gen_vadduwm(JITC &jitc)
{
    int vrD, vrA, vrB;
    PPC_OPC_TEMPL_X(jitc.current_opc, vrD, vrA, vrB);
    return gen_vec_binop(jitc, emit_vadduwm, vrD, vrA, vrB);
}

static void emit_vsububm(JITC &jitc)
{
    jitc.asmSUB_V_16B(V0, V0, V1);
}
JITCFlow ppc_opc_gen_vsububm(JITC &jitc)
{
    int vrD, vrA, vrB;
    PPC_OPC_TEMPL_X(jitc.current_opc, vrD, vrA, vrB);
    return gen_vec_binop(jitc, emit_vsububm, vrD, vrA, vrB);
}

static void emit_vsubuhm(JITC &jitc)
{
    jitc.asmSUB_V_8H(V0, V0, V1);
}
JITCFlow ppc_opc_gen_vsubuhm(JITC &jitc)
{
    int vrD, vrA, vrB;
    PPC_OPC_TEMPL_X(jitc.current_opc, vrD, vrA, vrB);
    return gen_vec_binop(jitc, emit_vsubuhm, vrD, vrA, vrB);
}

static void emit_vsubuwm(JITC &jitc)
{
    jitc.asmSUB_V_4S(V0, V0, V1);
}
JITCFlow ppc_opc_gen_vsubuwm(JITC &jitc)
{
    int vrD, vrA, vrB;
    PPC_OPC_TEMPL_X(jitc.current_opc, vrD, vrA, vrB);
    return gen_vec_binop(jitc, emit_vsubuwm, vrD, vrA, vrB);
}

static void emit_vaddfp(JITC &jitc)
{
    jitc.asmFADD_V_4S(V0, V0, V1);
}
JITCFlow ppc_opc_gen_vaddfp(JITC &jitc)
{
    int vrD, vrA, vrB;
    PPC_OPC_TEMPL_X(jitc.current_opc, vrD, vrA, vrB);
    return gen_vec_binop(jitc, emit_vaddfp, vrD, vrA, vrB);
}

static void emit_vsubfp(JITC &jitc)
{
    jitc.asmFSUB_V_4S(V0, V0, V1);
}
JITCFlow ppc_opc_gen_vsubfp(JITC &jitc)
{
    int vrD, vrA, vrB;
    PPC_OPC_TEMPL_X(jitc.current_opc, vrD, vrA, vrB);
    return gen_vec_binop(jitc, emit_vsubfp, vrD, vrA, vrB);
}
...
JITCFlow ppc_opc_gen_vspltisb(JITC &jitc)
{
    ...
    int vrD, vrB;
    uint32 simm;
    PPC_OPC_TEMPL_X(jitc.current_opc, vrD, simm, vrB);
    (void)vrB;
    sint8 val = (simm & 0x10) ? (sint8)(simm | 0xE0) : (sint8)simm;
    jitc.asmMOV(W0, (uint32)(uint8)val);
    jitc.asmDUP_V_16B_reg(V0, W0);
    jitc.asmSTR_Q_cpu(V0, VR_OFS(vrD));
    return flowContinue;
}
...
JITCFlow ppc_opc_gen_vspltish(JITC &jitc)
{
    ...
    PPC_OPC_TEMPL_X(jitc.current_opc, vrD, simm, vrB);
    (void)vrB;
    sint16 val = (simm & 0x10) ? (sint16)(simm | 0xFFE0) : (sint16)simm;
    jitc.asmMOV(W0, (uint32)(uint16)val);
    jitc.asmDUP_V_8H_reg(V0, W0);
    jitc.asmSTR_Q_cpu(V0, VR_OFS(vrD));
    return flowContinue;
}
...
JITCFlow ppc_opc_gen_vspltisw(JITC &jitc)
{
    ...
    PPC_OPC_TEMPL_X(jitc.current_opc, vrD, simm, vrB);
    (void)vrB;
    sint32 val = (simm & 0x10) ? (sint32)(simm | 0xFFFFFFE0) : (sint32)simm;
    jitc.asmMOV(W0, (uint32)val);
    jitc.asmDUP_V_4S_reg(V0, W0);
    jitc.asmSTR_Q_cpu(V0, VR_OFS(vrD));
    return flowContinue;
}
...
JITCFlow ppc_opc_gen_vspltw(JITC &jitc)
{
    ...
    int vrD, vrB;
    uint32 uimm;
    PPC_OPC_TEMPL_X(jitc.current_opc, vrD, uimm, vrB);
    jitc.asmLDR_Q_cpu(V0, VR_OFS(vrB));
    int lane = 3 - (uimm & 3);
    jitc.asmDUP_V_4S_elem(V0, V0, lane);
    jitc.asmSTR_Q_cpu(V0, VR_OFS(vrD));
    return flowContinue;
}
...
{
    if (jitc.current_opc & PPC_OPC_VRc) {
        ppc_opc_gen_interpret(jitc, ppc_opc_vcmpequwx);
        return flowContinue;
    }
    int vrD, vrA, vrB;
    PPC_OPC_TEMPL_X(jitc.current_opc, vrD, vrA, vrB);
...
{
    if (jitc.current_opc & PPC_OPC_VRc) {
        ppc_opc_gen_interpret(jitc, ppc_opc_vcmpequbx);
        return flowContinue;
    }
    int vrD, vrA, vrB;
    PPC_OPC_TEMPL_X(jitc.current_opc, vrD, vrA, vrB);
...
{
    if (jitc.current_opc & PPC_OPC_VRc) {
        ppc_opc_gen_interpret(jitc, ppc_opc_vcmpequhx);
        return flowContinue;
    }
    int vrD, vrA, vrB;
    PPC_OPC_TEMPL_X(jitc.current_opc, vrD, vrA, vrB);
